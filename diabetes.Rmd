---
title: "Predicting Hospital Readmission for Diabetes patients"
...
Loading the data
```{r}
raw.data <- read.csv("/home/sunbeam/R_loveeshbhat_imarticus/programs/R_project/github/provided_files/diabetes_allcols.csv",sep = ",", header = T, na.strings = "?")
head(raw.data)
summary(raw.data)
```
